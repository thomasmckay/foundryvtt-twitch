...
class _Arg {
    ...
    constructor() {
        this.flagSymbol = Symbol('arg flag');
    }


    parse(opts, {argv = [], permissive = false, stopAtPositional = false} = {}) {
        if (!opts) {
        ...
        for (const key of Object.keys(opts)) {
            ...
            if (Array.isArray(type) && type.length === 1 && typeof type[0] === 'function') {
                ...
                isFlag = fn === Boolean || fn[this.flagSymbol] === true;
            } else if (typeof type === 'function') {
                isFlag = type === Boolean || type[this.flagSymbol] === true;
            } else {
